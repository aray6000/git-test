      ...
      <section className="py-4 px-4">
        <div className="container mx-auto">
          <AdBox 
            size="banner" 
            position="content" 
            title="Premium Hosting - 50% Off"
            description="Deploy your apps with lightning speed"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 space-y-4">
            <AdBox 
              ...
              description="Advanced IDE for developers. Try free for 30 days!"
            ...
            <AdBox 
              ...
              position="sidebar" 
              title="API Services"
              description="Scale your apps with our robust APIs"
